...
const props = defineProps({
	...
	// 操作按钮风格位置
	layout: propTypes.string.validate((v: any) => ['inline', 'bottom'].includes(v)).def('inline'),
	// 底部按钮风格位置
	buttonProsition: propTypes.string
		.validate((v: any) => ['left', 'center', 'right'].includes(v)).def('center'),
...
const bottonButtonStyle = computed(() => {
	return {
		textAlign: props.buttonProsition
	}
}) as CSSProperties
